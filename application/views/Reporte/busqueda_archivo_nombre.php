       ...
       $this->Cell(10);
        ...
        $this->Cell(10);
            $this->SetFont('Arial','B',8);
                ...
                $this->SetFont('Arial','',8);$this->Cell(25,4,utf8_decode('NAPO'),0,1,'L');
        $this->Cell(10);
            $this->SetFont('Arial','B',8);
                $this->Cell(50,4,'FECHA INICIAL',0,0,'L');
                $this->Cell(3,4,utf8_decode(':'),0,0,'C');
                $this->SetFont('Arial','',8);$this->Cell(45,4,utf8_decode('INICIO_ACTIVIDAD'),0,0,'L');
            $this->SetFont('Arial','B',8);
                $this->Cell(35,4,'FECHA FINAL',0,0,'L');
                $this->Cell(3,4,utf8_decode(':'),0,0,'C');
                $this->SetFont('Arial','',8);$this->Cell(25,4,utf8_decode('FIN_ACTIVIDAD'),0,1,'L');
        $this->Cell(10);
            $this->SetFont('Arial','B',8);
                $this->Cell(50,4,'CI',0,0,'L');
                $this->Cell(3,4,utf8_decode(':'),0,0,'C');
                $this->SetFont('Arial','',8);$this->Cell(45,4,utf8_decode('DEPATAMENTO'),0,0,'L');
            $this->SetFont('Arial','B',8);
                $this->Cell(35,4,utf8_decode('Nª HOJA DE RUTA'),0,0,'L');
                $this->Cell(3,4,utf8_decode(':'),0,0,'C');
                $this->SetFont('Arial','',8);$this->Cell(25,4,utf8_decode('ESTADO'),0,1,'L');
                $this->Ln(7);
        $this->Cell(10);
         $this->SetFont('Arial','B',9);
                $this->Cell(50,4,'DATOS GENERALES',0,0,'L');
                $this->Ln(7);
        $this->Cell(10);
            $this->SetFont('Arial','B',8);
                $this->Cell(50,4,utf8_decode('Nª DE CAJA'),0,0,'L');
                $this->Cell(3,4,utf8_decode(':'),0,0,'C');
                $this->SetFont('Arial','',8);$this->Cell(45,4,utf8_decode('SECTOR'),0,0,'L');
            $this->SetFont('Arial','B',8);
                $this->Cell(35,4,utf8_decode('Nª DE TOMO'),0,0,'L');
                $this->Cell(3,4,utf8_decode(':'),0,0,'C');
                $this->SetFont('Arial','',8);$this->Cell(25,4,utf8_decode('Bs. '.'DEUDA_PRESUNTA'),0,1,'L');
        $this->Cell(10);
            $this->SetFont('Arial','B',8);
            ...
            $this->SetFont('Arial','B',8);
                ...
                $this->Cell(3,4,utf8_decode(':'),0,0,'C');
                $this->SetFont('Arial','',8);$this->Cell(25,4,utf8_decode('DEUDA_PRESUNTA'),0,1,'L');
                $this->Ln(7);
        $this->Cell(10);
        $this->SetFont('Arial','B',9);
                $this->Cell(50,4,utf8_decode('DATOS TÉCNICOS'),0,0,'L');
                $this->Ln(7);
        $this->Cell(10);
        ...
        $this->Cell(10);
            $this->SetFont('Arial','B',8);
                ...
                $this->SetFont('Arial','',8);$this->Cell(45,4,utf8_decode('SECTOR'),0,0,'L');
            $this->SetFont('Arial','B',8);
                $this->Cell(35,4,utf8_decode('PLAN'),0,0,'L');
                $this->Cell(3,4,utf8_decode(':'),0,0,'C');
                $this->SetFont('Arial','',8);$this->Cell(25,4,utf8_decode('Bs. '.'DEUDA_PRESUNTA'),0,1,'L');
        $this->Cell(10);
            $this->SetFont('Arial','B',8);
            ...
            $this->SetFont('Arial','B',8);
                ...
                $this->Cell(10);
        $this->SetFont('Arial','B',9);
                $this->Cell(50,4,utf8_decode('UBICACIÓN FÍSICA'),0,0,'L');
                $this->Ln(7);
        $this->Cell(10);
             $this->SetFont('Arial','B',8);
                $this->Cell(50,4,utf8_decode('AMBIENTE'),0,0,'L');
                $this->Cell(3,4,utf8_decode(':'),0,0,'C');
                $this->SetFont('Arial','',8);$this->Cell(45,4,utf8_decode('SECTOR'),0,0,'L');
            $this->SetFont('Arial','B',8);
